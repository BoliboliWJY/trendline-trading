...
class Plotter:
    ...
    def update_plot_initial(self):
        ...
        trend_high, trend_low, self.last_filtered_high, self.last_filtered_low = compute_initial_trends(self.current_data, self.trend_generator, self.data, self.trend_config, self.last_filtered_high, self.last_filtered_low)
        # 根据计算结果绘制图像
