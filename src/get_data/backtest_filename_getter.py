...
def get_backtest_filename(coin_type, interval, length, backtest_start_time, backtest_end_time,contract_type):
    backtest_dir = os.path.join(os.getcwd(), f'backtest/{contract_type}/k_lines')
